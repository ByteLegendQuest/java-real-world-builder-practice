...
`git clone https://github.com/ByteLegendQuest/java-real-world-builder-practice`

A project directory named `java-real-world-builder-practice` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-real-world-builder-practice` directory which is created just now.
